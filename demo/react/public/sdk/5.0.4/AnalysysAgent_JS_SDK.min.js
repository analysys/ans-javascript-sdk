(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  // 预制事件列表与事件属性
  var events = {
      $startup: __spreadArrays(utmAttrs, commonAttrs, ['$is_first_time' //首次访问，只在startUp
      ]),
      $end: __spreadArrays(commonAttrs, ['$duration' //使用时长
      ]),
      $pageview: __spreadArrays(utmAttrs, commonAttrs, ['$url_domain', '$referrer', '$referrer_domain', '$startup_time' // 此行下面5个只在 pageView 中有
      ]),
      ...
      $alias: ['$original_id'],
      $getPresetProperties: __spreadArrays(commonAttrs, [firstVisitTime])
  };
  ...
  */
  ...
  var implementBeforeInit = function (fn) {
      ...
      if (beforeInit) {
          var f = beforeInit.call(globalWindow.AnalysysAgent, config, next);
  ...
  function sendData(data, fn, isTrack) {
      ...
      if (isHybrid && ['$web_click', '$webstay', '$user_click'].indexOf(xwhat) === -1) {
          ...
          var arr = ['$is_first_day', '$session_id', '$is_time_calibrated', '$startup_time', '$lib', '$lib_version', '$platform'];
  ...
  function pageClose() {
      ...
      console.log(res.xwhen, eventAttribute.pageview.xwhen, getHideTime(), res.xwhen - eventAttribute.pageview.xwhen - getHideTime());
      var attrs = {
  ...
  function setPageHideTime() {
      if ('onvisibilitychange' in document && config.autoPageViewDuration) {
          ...
          document.addEventListener('visibilitychange', function () {
              ...
              console.log(eventAttribute.pageClose.hideTime);
          });
      }
  }
