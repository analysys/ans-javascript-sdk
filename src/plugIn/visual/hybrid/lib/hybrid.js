...
import { getRelated, domParentList, eleOffset, getConstantStyle } from '../../visualShow/common/index.js'
import { getElementContent } from '../../utils/elementContent'
...
var HybridAns = {
  ...
  onEventList: function (list) {
    ...
    console.log('Get Visual Event List from app')
