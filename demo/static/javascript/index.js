 ...
 */
function showSuperProperty(value) {
    alert('通用属性--->' + value)
    console.log('通用属性--->', value)
}

function getSuperProperty(superPropertyName) {
    var superrProperty = AnalysysAgent.getSuperProperty(superPropertyName, showSuperProperty);
    if (superrProperty) {
...
function getSuperProperties() {
    var superrProperty = AnalysysAgent.getSuperProperties(showSuperProperty);
    if (superrProperty) {
        console.log('通用属性--->', superrProperty)
    }
}
...
function getDistinctId() {
    var distinctId = AnalysysAgent.getDistinctId(showDistinctId)
    if (distinctId) {
